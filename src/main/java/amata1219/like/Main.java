    ...
    public void onEnable() {
        ...
        getServer().getScheduler().runTaskLater(this, () -> {
            ...
            if (tourConfig.notificationIsEnabled())
                tourRegularNotificationTask = getServer().getScheduler().runTaskTimerAsynchronously(this, new TourRegularNotificationTask(tourConfig), tourConfig.notificationIntervalTicks(), tourConfig.notificationIntervalTicks());
        }, 15);
    }
